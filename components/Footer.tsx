const Footer = () => {
    return (
        <div className="text-white text-center top-[7rem] relative">
           ...
           <div>
           Source code open sourced at <a href="https://github.com/hackclub/gas-fund" className="font-bold no-underline">hackclub/gas-fund</a> and finances released on <a href="https://hcb.hackclub.com/hq-gas-fund" className="font-bold no-underline">HCB</a>.
           </div>
        </div>
    );
}
